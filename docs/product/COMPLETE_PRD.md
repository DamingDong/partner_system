...
#### 系统管理员
- **职责**：系统配置、渠道编码管理，以及**导入待绑定会员卡池**
- **权限**：完整系统访问权限，全局数据管理
- **使用场景**：会员卡池导入、系统配置、权限管理

#### 渠道方案商（一级代理）
- **职责**：通过Excel导入绑定MAC地址，查看业务数据
- **权限**：管理会员卡绑定，查看所有下级数据
- **使用场景**：MAC地址绑定、业务数据查看、订单管理

#### 酒店运营商（一级代理）
- **职责**：管理多个酒店和房间设备，通过Excel导入绑定MAC地址
- **权限**：设备绑定管理，查看自己业务数据
- **使用场景**：酒店设备绑定、激活数据跟踪
